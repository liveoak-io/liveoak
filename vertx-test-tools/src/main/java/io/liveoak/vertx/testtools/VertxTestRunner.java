package io.liveoak.vertx.testtools;
 ...
 *
 */
public class VertxTestRunner extends BlockJUnit4ClassRunner {

    public static final String TESTRUNNER_HANDLER_ADDRESS = "vertx.testframework.handler";

    private static final Logger log = LoggerFactory.getLogger(VertxTestRunner.class);
    ...
    public VertxTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
