 ...
 */
public class HttpCreateResourceRequestEncoder extends MessageToMessageEncoder<ResourceCreatedResponse> {

    private final Container container;

    public HttpCreateResourceRequestEncoder(Container container) {
        this.container = container;
    }

    @Override
    protected void encode(ChannelHandlerContext ctx, ResourceCreatedResponse msg, List<Object> out) throws Exception {
