 ...
 */
public class HttpCreateResourceRequestDecoder extends MessageToMessageDecoder<FullHttpRequest> {

    private final Container container;

    public HttpCreateResourceRequestDecoder(Container container) {
    ...
    protected void decode(ChannelHandlerContext ctx, FullHttpRequest request, List<Object> out) throws Exception {
        ...
        if (path.isCollectionPath() && request.getMethod() == HttpMethod.POST) {
            //TODO: Probably need to support http chunks ?
            out.add(new CreateResourceRequest(path.getType(), path.getCollectionName(), request.content()));
        } else {
