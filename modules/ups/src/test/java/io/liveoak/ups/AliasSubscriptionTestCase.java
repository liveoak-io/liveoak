...
public class AliasSubscriptionTestCase extends BaseUPSTestCase {
    ...
    public void testSimpleAliasSubscription() throws Exception {
        ...
        ResourceState readResponse = client.read( new RequestContext.Builder().returnFields( ( new ReturnFieldsImpl( "*" ).withExpand( "members" ) ) ).build(), "/testApp/" + BASEPATH + "/aliases/" + alias );
