...
public class MongoDBCollectionCreateTest extends BaseMongoDBTest {
    ...
    public void testCreateCollection() throws Exception {
        ...
        ResourceState createdResource = client.create(new RequestContext.Builder().build(), "/testOrg/testApp/storage", state);
        ...
        ResourceState movies = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/storage/movies");
    ...
    public void testCreateEmptyCollection() throws Exception {
        ...
        ResourceState response = client.create(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH, state);
    ...
    public void testCreateCollectionNoId() throws Exception {
        ...
        ResourceState response = client.create(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH, new DefaultResourceState());
    ...
    public void testCreateAlreadyExisting() throws Exception {
        ...
        try {
            ResourceState response = client.create(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH, new DefaultResourceState("foobar"));
