...
public class MongoDBResourceDeleteTest extends BaseMongoDBTest {
    ...
    public void testSimpleDelete() throws Exception {
        ...
        ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/" + methodName + "/" + id);
    ...
    public void testDirectDeleteProperty() throws Exception {
        ...
        try {
            ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/" + methodName + "/" + id + "/foo");
    ...
    public void testDeleteChildObject() throws Exception {
        ...
        try {
            ResourceState result = client.delete(new RequestContext.Builder().returnFields(new ReturnFieldsImpl("bar(ABC(*))")).build(), BASEPATH + "/" + methodName
                    + "/" + id + "/foo");
    ...
    public void testDeleteChildProperty() throws Exception {
        ...
        // we should not be able to directly delete a child property
        try {
            ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/" + methodName + "/" + id + "/foo/bar");
    ...
    public void testDeleteNonExistantCollection() throws Exception {
        ...
        try {
            ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/" + methodName);
    ...
    public void testDeleteInvalidId() throws Exception {
        ...
        try {
            ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/foobar123");
            Fail.fail("shouldn't get here");
        } catch (ResourceNotFoundException e) {
            // expected
        }
    ...
    public void testDeleteNonExistantId() throws Exception {
        ...
        try {
            ResourceState result = client.delete(new RequestContext.Builder().build(), BASEPATH + "/" + methodName + "/" + id.toString());
            Fail.fail("shouldn't get here");
        } catch (ResourceNotFoundException e) {
            // expected
        }
