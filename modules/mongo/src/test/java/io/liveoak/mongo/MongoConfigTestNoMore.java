 ...
 */
public class MongoConfigTestNoMore extends BaseMongoDBTest {
    ...
    public void testReadConfigOnRoot() throws Exception {
        ...
        ResourceState result = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config");
    ...
    public void testReadConfigOnCollection() throws Exception {
        ...
        try {
            client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + ";config");
            fail();
    ...
    public void testReadConfigOnNonExistantCollection() throws Exception {
        ...
        // currently we don't have config options on collections, so this should fail
        try {
            client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/foo;config");
            fail();
        } catch (ResourceNotFoundException e) {
            // expected
        }
    ...
    public void testModifyMongoConfig() throws Exception {
        ...
        ResourceState configResult = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config");
        ...
        ResourceState messageResult = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/message");
        assertThat(messageResult.getProperty("text")).isEqualTo("hello world");

        // update the configuration values
        configResult.putProperty("db", "testB");
        ResourceState updateResult = client.update(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config", configResult);
        assertThat(updateResult.getProperty("db")).isEqualTo("testB");

        // verify the new configuration values
        ResourceState configResultUpdated = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config");
        ...
        ResourceState messageResultB = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/message");
    ...
    public void testModifyMongoInvalidDatabase() throws Exception {
        ...
        try {
            client.update(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config", configResult);
            fail();
...
//        }
        ...
        ResourceState state = client.update(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config", configResult);
...
//        }
        ...
        try {
            client.update(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + ";config", configResult);
            fail( "should have had an exception about invalid host" );
        } catch (ResourceException e) {
            //expected
        }
