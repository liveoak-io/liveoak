...
public class MongoDBResourceReadTest extends BaseMongoDBTest {
    ...
    public void testGetSimple() throws Exception {
        ...
        ResourceState result = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/" + id);
    ...
    @Test
    public void testSimilarIDs() throws Exception {
        String methodName = "testSimpleGet";
        assertFalse(db.collectionExists(methodName));
        ...
        ResourceState resultObject = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/_mOI:01234567890ABCDEF0123456");
        ResourceState resultString = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/01234567890ABCDEF0123456");
    ...
    public void testGetEmbeddedWithReturnFields() throws Exception {
        ...
        ResourceState result = client.read(rCtx, "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/" + id);
        ...
        result = client.read(rCtx, "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/" + id);
    ...
    public void testGetChildDirectly() throws Exception {
        ...
        try {
            ResourceState result = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/" + id + "/child");
            Fail.fail();
    ...
    public void testGetArray() throws Exception {
        ...
        ResourceState result = client
                .read(new RequestContext.Builder().returnFields(new ReturnFieldsImpl("*(*(*))")).build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/foobaz");
        ...
        try {
            result = client.read(new RequestContext.Builder().returnFields(new ReturnFieldsImpl("*(*(*))")).build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/foobaz/child");
            Fail.fail();
        } catch (ResourceNotFoundException e) {
            // expected
        }
    ...
    public void testGetCollection() throws Exception {
        ...
        try {
            ResourceState result = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/foobaz/array");
            Fail.fail();
        } catch (ResourceNotFoundException e) {
            // expected
        }
    ...
    public void testGetInvalidId() throws Exception {
        ...
        try {
            ResourceState result = client.read(new RequestContext.Builder().build(), "/testOrg/testApp/" + BASEPATH + "/" + methodName + "/foobar123");
