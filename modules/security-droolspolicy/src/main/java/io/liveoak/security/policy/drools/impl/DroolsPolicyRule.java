...
/**
 * Single entry of {@link DroolsPolicy}
 *
 * @author <a href="mailto:mposolda@redhat.com">Marek Posolda</a>
 */
public class DroolsPolicyRule {
    ...
    private DroolsPolicyRule(int id, int priority, String uriPattern, String queryParamsCondition, String requestType, String allowedRoles, String deniedRoles,
    ...
    public static DroolsPolicyRule createRule(int id, int priority, String uriPattern, String queryParamsCondition, String requestType,
        ...
        return new DroolsPolicyRule(id, priority, formattedPattern, queryParamsCondition, requestType, allowedRoles, deniedRoles,
